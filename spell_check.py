"""
Spell checker with 2 edit distance.
Used, slightly modified from https://github.com/makcedward/nlp/blob/master/aion/util/spell_check.py
"""
...
class SymSpell(SpellCheck):
    ...
    def correction(self, word, max_edit_distance_lookup=2, mode='cloest'):
        ...
        results = [{'word': suggestion.term, 'count': suggestion.count, 'distance': suggestion.distance} for suggestion
                   in results]
        return results
